...
class TestFlunkyLvl2:
    def test_key(cog_flunky_lvl2):
        assert cog_flunky_lvl2.key == "f"

    def test_name(cog_flunky_lvl2):
        assert cog_flunky_lvl2.name == "Flunky"

    def test_level(cog_flunky_lvl2):
        assert cog_flunky_lvl2.level == 2

    def test_health(cog_flunky_lvl2):
...
class TestFlunkyLvl3:
    def test_key(cog_flunky_lvl3):
        assert cog_flunky_lvl3.key == "f"

    def test_name(cog_flunky_lvl3):
        assert cog_flunky_lvl3.name == "Flunky"

    def test_level(cog_flunky_lvl3):
        assert cog_flunky_lvl3.level == 3

    def test_health(cog_flunky_lvl3):
